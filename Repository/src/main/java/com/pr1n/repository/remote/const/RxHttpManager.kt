package com.pr1n.repository.remote.const
...
const val CONSULT_URL = "http://test-yys-api.xadazhihui.cn/consult/list"

const val DOCTOR_SEARCH_URL = "http://test-yys-api.xadazhihui.cn/consult/doctor-search"
