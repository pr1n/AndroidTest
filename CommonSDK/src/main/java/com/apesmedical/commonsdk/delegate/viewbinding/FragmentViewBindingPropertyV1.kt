package com.apesmedical.commonsdk.delegate.viewbinding
...
/**
 * @author Beetle_sxy
 * @ClassName: FragmentViewBindingPropertyV1
 * @Description: Fragment V1
 * @date: 2021/5/17
 */
...
class FragmentViewBindingPropertyV1<in F : Fragment, out V : ViewBinding>(
    ...
    inner class ClearOnDestroyLifecycleObserver : LifecycleObserver {
